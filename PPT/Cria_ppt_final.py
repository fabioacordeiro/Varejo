...
# Cria novo Excel com os dados filtrados
sinistro_df.to_excel("C:\\Fabio\\Desenvolvimento\\Varejo\\PPT\\SINISTROS_FILTRADO.xlsx", index=False)

# Looping para definir qual tipo de sinistro (Definir tipo de template a ser utilizado)
print("Informe qual o tipo de sinistro, conforme abaixo:")
print("A - Acidente / Avaria / Tombamento / Colisão")
print("R - Roubo / Furto")
print("V - Variação Temperatura")
tp_sinistro = ""
tipo_sinistro = {"A","R","V"}
while tp_sinistro not in tipo_sinistro:
    #A variável abaixo vai pegar somente o primeiro caractér e transformara em maiúsculo
    tp_sinistro = input('Informe qual o tipo de sinistro:').strip().upper()[:1]
print("Tipo de sinistro informado: {tp_sinistro}")

template_path = None
template_path = None
if tp_sinistro == "A":
    if template_path is None:
        template_path = 'C:\\Fabio\\Desenvolvimento\\Varejo\\PPT\\TemplateA.pptx'
if tp_sinistro == "R":
    if template_path is None:
        template_path = 'C:\\Fabio\\Desenvolvimento\\Varejo\\PPT\\TemplateR.pptx'
if tp_sinistro == "V":
    if template_path is None:
        template_path = 'C:\\Fabio\\Desenvolvimento\\Varejo\\PPT\\TemplateV.pptx'
...
def criar_apresentacao_sinistro(numero_sinistro=None, excel_file=None):
    """
