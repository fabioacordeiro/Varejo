...
# Extração de dados equivalentes (com alguns campos preenchidos manualmente ou por inferência para exemplo)
cliente =  row["Filial"]
...
Data: {data}
MOTIVO: {motivo}
CAIXA DE TEMPERATURA: {faixa_temperatura}
Origem: {origem}
Destino: {destino}
...
email_transp = 'fabio_cordeiro@carrefour.com'
corpo_email = f"""
<html>
